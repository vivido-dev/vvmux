...
pub use manifest::{
    ...
    IntegrationRegistration, Keybinding, LinkHandler, LoadedManifest, MAX_AGENT_RESUME_ARGS,
    MAX_INTEGRATION_FILE_BYTES, MAX_KEYBINDINGS_PER_PLUGIN, MAX_LINK_HANDLERS_PER_PLUGIN,
    MAX_LINK_PATTERN_BYTES, Manifest, ManifestError, Pane, Permission, Placement, Plugin,
    RESUME_ID_PLACEHOLDER, RESUME_PATH_PLACEHOLDER, Runtime, RuntimeKind, SchemaDocument, Workflow,
    WorkflowStep, validate_schema_instance,
};
pub use protocol::{
